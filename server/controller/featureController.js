...
export const readPdf = async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      message: 'PDF upload received (parsing not implemented in demo)',
      extractedText: 'PDF parsing feature is not fully implemented in this demo version. Please use the text input instead.',
      metadata: {
